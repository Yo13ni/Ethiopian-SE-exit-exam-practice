"""Build predicted 2018 exit exam v2 JSON (questions + deep explanations)."""
...
from exam2018v2_data import FOCUS_GUIDE_V2, PREDICTED_2018V2_QUESTIONS  # noqa: E402
from generic_deep_builder import build_deep_entry, enrich_with_concept  # noqa: E402

OUT_DIR = ROOT / "data" / "exams" / "2018v2"
...
def main() -> None:
    ...
    questions = []
    for i, raw in enumerate(PREDICTED_2018V2_QUESTIONS, start=1):
        q = dict(raw)
        q["examNumber"] = i
        q["id"] = i
        questions.append(q)
    ...
    payload = {
        "title": "2018 Prediction v2",
        "source": "Feb 2024 MoEE blueprint cognitive domains — scenario, apply, analyze, evaluate, and design stems",
        "total": len(questions),
        "timeLimitHours": 3,
        "dataRevision": 2,
        "predicted": True,
        "predictionVersion": 2,
        "predictionMethod": "historical-trend-scenario",
